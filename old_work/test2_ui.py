# Form implementation generated from reading ui file '/opt/programming/openemis_minus_gui/old_work/test2.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.comboBox.setItemText(0, _translate("Dialog", "انس"))
        self.comboBox.setItemText(1, _translate("Dialog", "مؤمن"))
        self.comboBox.setItemText(2, _translate("Dialog", "محمد خالد"))
        self.comboBox.setItemText(3, _translate("Dialog", "عسبلي"))
        ...
        self.label_3.setText(_translate("Dialog", "<html><head/><body><p align=\"center\">الاولى</p></body></html>"))
